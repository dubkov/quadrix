...
// this is version that uses PROGMEM to store image bitmap.
...
PROGMEM prog_uint16_t theBigX[ROWSNUM]={
0b0000000000000000,
0b1111000000001111,
0b0110000000000110,
0b0011000000001100,
...
void loop()
 ...
 void show(prog_uint16_t picture[16]){
    for (int j=0;j<HALFROWSNUM;j++){
      selectRow(j);
      transferLines(pgm_read_word(&(picture[j])),pgm_read_word(&(picture[j+HALFROWSNUM])));
      showLine();
   }
 }
